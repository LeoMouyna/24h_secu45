...
\multicolumn{3}{|c|}{\includegraphics[height=4cm]{Annexes/Trombi_orgas/Tresorier}} & \multicolumn{3}{c|}{\includegraphics[height=4cm]{Annexes/Trombi_orgas/Orga_billetterie}} & \multicolumn{3}{c}{\includegraphics[height=4cm]{Annexes/Trombi_orgas/Orga_barriere_1}} & \multicolumn{3}{c|}{\includegraphics[height=4cm]{Annexes/Trombi_orgas/Orga_barriere_2}}\\
...
\multicolumn{4}{|m{5.33cm}}{\rule{0pt}{2ex}} & \multicolumn{4}{m{5.33cm}}{} & \multicolumn{4}{m{5.33cm}|}{} \\
\multicolumn{4}{|c}{\centering\includegraphics[height=4cm]{Annexes/Trombi_orgas/Orga_catering_1}}  & \multicolumn{4}{c}{\includegraphics[height=4cm]{Annexes/Trombi_orgas/Orga_catering_2}} & \multicolumn{4}{c|}{\includegraphics[height=4cm]{Annexes/Trombi_orgas/Orga_catering_3}} \\
...
\multicolumn{4}{|m{5.33cm}}{\rule{0pt}{2ex}} & \multicolumn{4}{m{5.33cm}}{} & \multicolumn{4}{m{5.33cm}|}{} \\
\multicolumn{4}{|c}{\centering\includegraphics[height=4cm]{Annexes/Trombi_orgas/Orga_signa}}  & \multicolumn{4}{c}{\includegraphics[height=4cm]{Annexes/Trombi_orgas/Orga_deco_1}} & \multicolumn{4}{c|}{\includegraphics[height=4cm]{Annexes/Trombi_orgas/Orga_deco_2}} \\
...
\multicolumn{4}{|m{5.33cm}}{\rule{0pt}{2ex}} & \multicolumn{4}{m{5.33cm}}{} & \multicolumn{4}{m{5.33cm}|}{} \\
\multicolumn{4}{|c}{\centering\includegraphics[height=4cm]{Annexes/Trombi_orgas/Orga_log_2}}  & \multicolumn{4}{c}{\includegraphics[height=4cm]{Annexes/Trombi_orgas/Orga_log_1}} & \multicolumn{4}{c|}{\includegraphics[height=4cm]{Annexes/Trombi_orgas/Orga_log_3}} \\
...
\cmidrule{2-5}
 & Bobine Tesla & Une bobine tesla qui produits des éclairs sera installée sur le terrain stabilisé au nord de la piscine avant le feu d'artifice. Des dispositifs de sécurité sont mis en place à ce sujet. & \ref{bobine_tesla} & \pageref{bobine_tesla}\\
\midrule
...
\begin{list}{•}{}
	\item (E) À eau : au niveau des espaces de vente, aux entrées et aux toilettes
	\item (C) À CO2 : à proximité d’installations électriques 
...
Étant donné la configuration de notre zone, nous ne pourrons mettre en place qu'un maximum de trois sorties, réparties sur toute la façade est de l'espace de restauration. En revanche, nous avons un total de \textbf{22 UP}, pour un minimum de 15 UP, soit un \textbf{différentiel positif de 7 UP}. 
...
\subsubsection{Évacuation avec électricité}
...
\subsubsection{Évacuation sans Électricité}
...
%
%\begin{center}
%	\includegraphics[width=.8\textwidth,keepaspectratio]{Exports/Plan_24h_45eme-Zone_de_travaux}
...
À ce titre, les responsables sécurité du festival sollicitent au plus tôt nos différents partenaires de longue date afin de leur faire part des nouveautés de l’édition en préparation et ainsi s’assurer que les dispositifs de sécurité et de sûreté prévus sont adaptés et correctement dimensionnés dans le cadre du plan Vigipirate.\\
...
\vspace{0.1cm}
  ...
  - Direction Générale des Services INSA Lyon} & 
...
\begin{list}{•}{}
	\item sensibiliser les bénévoles sur la menace et sur les mesures du plan Vigipirate ;
...
Les festivaliers sont quant à eux informés du dispositif de sécurité mis en place \textit{via} les Conditions Générales de Vente lors de l'achat de leur billet et sont priés de se soumettre à l'ensemble des contrôles de sûreté. Toute personne refusant un contrôle d'accès se verra interdire l'accès à la zone ERP.
\end{list}
...
\begin{list}{•}{}
	...
	\item Les parkings aux abords immédiats de la zone ERP sont également interdits de stationnement plusieurs jours avant la manifestation. Les véhicules contrevenant sont enlevés.
...
De même, bien qu'un exercice de sûreté grandeur nature en lien avec les forces de l'ordre ne soit pas possible à cause de la durée réduite de la manifestation, des fiches de procédure d'évacuation individualisées sont distribuées en amont aux organisateurs jouant un rôle particulier si une évacuation du public devait avoir lieu. Plusieurs exercices d'évacuations de la zone sont effectués en amont de la manifestation avec les organisateurs et les bénévoles concernés.
...
\section{Diagnostic du plan Vigipirate}
\begin{center}
\begin{tabular}{ | p{13cm} | p{1cm} | p{1cm} | p{1cm} | }
\hline
	 & \multicolumn{3}{|l|}{Conformité}  \\ \hline
	 & Oui & Non & Sans objet \\ \hline
	1. DÉVELOPPER DES RELATIONS AVEC LES PARTENAIRES EXTÉRIEURS &  & \  & \ \\ \hline
	Organiser les relations avec les autorités de police administrative (préfet et maire) & X &  &  \\ \hline
	Partager l'appréciation du risque avec les forces de police, gendarmerie, police  municipale ou les sapeurs-pompiers & X &  &  \\ \hline
	2. SE FORMER ET FORMER LES PERSONNELS &  & \  & \  \\ \hline
	Se rapprocher des services de formations spécialisés & X &  &  \\ \hline
	Élaborer un plan de sensibilisation des personnels  & X &  &  \\ \hline
	3. ANALYSER LA MENACE DANS SON ENVIRONNEMENT &  & \  & \ \\ \hline
	Analyser les vulnérabilités du site & X &  &  \\ \hline
	Établir un annuaire des numéros d'urgence à jour & X &  &  \\ \hline
	Élaborer des procédures de sécurité & X &  &  \\ \hline
	Définir les modalités de surveillance du site & X &  &  \\ \hline
	4. ORGANISER LA SÉCURITÉ DE L'ÉVÉNEMENT & \ &  & \ \\ \hline
	Renforcer la vigilance et le contrôle des accès et des flux & X &  &  \\ \hline
	Mentionner les contrôles aux accès dans les Conditions Générales de Vente & X &  &  \\ \hline
	Informer le public sur les mesures de protection et de vigilance & X &  &  \\ \hline
	5. ASSURER LA PROTECTION DU SITE &  & \  & \ \\ \hline
	Assurer la protection du périmètre et de ses abords immédiats & X &  &  \\ \hline
	Envisager l'installation d'obstacles pour prévenir l'action d'un véhicule bélier sans nuire aux capacités d'intervention des secours & X &  &  \\ \hline
	Éviter les attroupements & X &  &  \\ \hline
	Stocker hors site et en sécurité, les clefs, les badges, les codes d'accès aux alarmes ainsi que les plans de lieux & X &  &  \\ \hline
	6. TESTER LE DISPOSITIF DE CRISE &  & \  & \  \\ \hline
	Tester le dispositif & X &  &  \\ \hline
	Organiser un exercice sûreté avec l'ensemble des bénévoles concernés & X &  &  \\ \hline
	Organiser un exercice sûreté en lien avec les forces de sécurité &  & X &  \\ \hline
\end{tabular}
...
\hline
	...
	Remarques &  \\ \hline
	Nombre d’agent(s) demandé(s) + horaires
 & 1 agent de sûreté et 1 «Étudiant sûreté» du samedi 19h au dimanche 6h \\ \hline
	Analyse des risques
...
L’animation se compose d’une cage à grimper de 8m de haut avec une tyrolienne de 40m de long arrivant sur l’herbe. Les utilisateurs peuvent monter à l’aide de filets, tout en étant assuré. Cette animation peut contenir 8 personnes en simultanées et est ouverte à tous.
...
\hline
	...
	3. CIRCULATIONS À L’INTÉRIEUR DES BÂTIMENTS &  &  & X \\ \hline
	4. ASCENSEUR &  &  & X \\ \hline
	...
	8. ÉTABLISSEMENTS D’HÉBERGEMENT HÔTELIER &  &  & X \\ \hline
	9. INSTALLATIONS SPORTIVES SOCIO-ÉDUCATIVES &  &  & X \\ \hline
...
Avant de pouvoir accéder à la zone des concerts, ces personnes vont devoir passer par la zone des caisses pour acheter un billet d’entrée. À l’arrivée à la zone des caisses, ces personnes seront prises en charge par un agent qui les accompagnera au niveau des caisses puis les fera entrer dans la zone, en suivant le parcours suivant :
...
\newpage
\section{Évacuation des personnes en situation de handicap}
