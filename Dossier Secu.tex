...
Cette année, le podium interplateau sera placé au milieu de la zone concert.

Il sera entouré de barrières type Vauban pour éviter que le public n'y ait accès et il sera surveillé en permanence par un agent de sureté.\\
...
\textbf{Tours Layher: }\\
Sur notre zone cette année, trois tours layher de taille différente vont être installées. Elle seront utilisées comme moyen de signalisation et décoration.
Les plan de ces tours sont donnés en annexe ( section \ref{Tour_Layher}).
...
Les deux tour Layher de 4 mètres de haut sont positionné en dehors de la zone public et servent de moyen de signalisation pour les toilettes.\

La tour Layher de 8 mètres de haut est elle positionné au dos du podium interplateau. Elle sera complètement recouverte par des baches décoratives et ce faisant sera inaccessible au public.\

Toutes ces tours seront lestées à l'aide de bloc de béton et contrôlées par un bureau de contrôle.\\
