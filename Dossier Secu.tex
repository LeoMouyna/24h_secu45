...
\textbf{Tours Layher: }\\
Trois tours Layher de taille différente vont être installées sur la zone. Elles seront utilisées comme moyen de signalisation et décoration.
...
Les deux tours Layher de 4 mètres de haut sont positionnées en dehors de la zone public et servent de moyen de signalisation pour les toilettes.\

La tour Layher de 8 mètres de haut est elle positionnée au dos du podium interplateau. Elle sera complètement recouverte par des baches décoratives et ce faisant sera inaccessible au public.\
...
Du vendredi 17 mai à 18h au dimanche 19 mai à 23h59, la \textbf{conditions d’accès} au campus est la suivante (vous trouverez ci-après le plan des points de sécurité du campus) :
\begin{list}{•}{}
...
Le Club des 24 heures  de l’INSA, désigné par la suite «l’Organisation», organise le festival «les 24 heures de l’INSA», dont la quarante-quatrième édition a lieu les 17, 18 et 19 mai 2019 sur le Campus de Lyon Tech - La Doua, 20 avenue Albert Einstein, 69100 Villeurbanne.\\
...
Une bobine Tesla est une machine électrique permettant d'atteindre de très hautes tensions et donc de produire des éclairs. Pour plus d'informations, veuillez vous référer au dossier Bobine Tesla en annexe. @@@A MODIFIER@@@
\begin{center}
...
Avant de pouvoir accéder à la Zone de Concerts, ces personnes vont devoir passer par la zone des caisses pour acheter un billet d’entrée. A l’arrivée à la zone des caisses, elles seront prises en charge par un agent qui les accompagnera au niveau des caisses puis les fera entrer dans la zone, en suivant le parcours suivant :
